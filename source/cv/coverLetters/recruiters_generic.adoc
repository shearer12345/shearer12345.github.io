...
I am technically capable across a wide set of technologies, though currently have a preference for {cpp}, 3D, Graphics, and high-performance computing (GPU etc).
