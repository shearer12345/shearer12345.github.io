...
Ability to lead complex projects at all levels (from high-level strategic discussions and strategic planning with involved parties (program managers, product managers, marketing, technical leaders, and executives), to getting hands dirty programming, building physical computing art installations in the real world), through the whole lifecycle (from concept to fully operational status) and across the whole technical spectrum (backend, front-end, hardware/firmware, UX, Ops/Infrastructure, CI/CD).
